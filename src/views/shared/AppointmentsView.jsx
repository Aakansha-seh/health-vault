...
function Modal({ title, onClose, children }) {
  return (
    ...
    >
      <div onMouseDown={e => e.stopPropagation()} className="hv-modal-card-anim" style={{ background: C.white, borderRadius: 16, width: '100%', maxWidth: 500, maxHeight: '85vh', overflowY: 'auto', padding: 28, boxSizing: 'border-box' }}>
